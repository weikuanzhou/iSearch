var XpiInstaller = {
    extFullName: "Interactive Search Now, Intelligent Search Future",
    extShortName: "isearch",
    extVersion: "0.0.5",
    extAuthor: "Zhou Weikuan",
    extLocaleNames: ["zh-CN"],
    extLicenseFile: "GPL",
    extSkinNames: ["original"],
    extPostInstallMessage: "Success! Please restart your browser to finish the installation.",
    profileInstall: true,
    silentInstall: true,
    install:function(){
        var _1 = this.extShortName + ".jar";
        var _2 = getFolder("Profile", "extensions/" 
                    + "{66ac69fd-1e20-4b48-800b-a25e85c5827a}");
        ...
        if( File.exists( Install.getFolder(_3,_1) ) ){
            ...
            if( !this.silentInstall ){
                this.profileInstall = Install.confirm("Install "
                        ...
                        + " " 
                        + this.extVersion
                        + " to your Profile directory (OK)" 
                        + " or your Browser directory (Cancel)?");
            }
        }
        ...
        var _8 = this.profileInstall?
            Install.PROFILE_CHROME : Install.DELAYED_CHROME;
        Install.registerChrome(Install.CONTENT|_8,
                _7,
        ...
        Install.addFile(null,this.extLicenseFile,_2,null);
